...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    //Keep track of which permissions we have requested
    private static final int FINE_LOCATION_PERMISSION_REQUEST_CODE = 599;
    ...
    public void onConnectionSuspended(int i) {
        Log.i(TAG, "API Client Connection Suspending!");
    }
