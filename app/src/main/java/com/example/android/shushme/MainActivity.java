...
public class MainActivity extends AppCompatActivity implements
    ...
    private Geofencing mGeofenceing;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onOffSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                editor.commit();
                if (isChecked) mGeofenceing.registerAllGeofences();
                else mGeofenceing.unRegisterAllGeofences();
            }
        });
        ...
        mGeofenceing = new Geofencing(this, mClient);
    }
    ...
    public void refreshPlacesData() {
        ...
        placeResult.setResultCallback(new ResultCallback<PlaceBuffer>() {
            ...
            public void onResult(@NonNull PlaceBuffer places) {
                ...
                // TODO/COMPELTED (11) Call updateGeofenceList and registerAllGeofences if mIsEnabled is true
                mGeofenceing.updateGeofenceList(places);
                if (mIsEnabled) {
                    mGeofenceing.registerAllGeofences();
                }
            }
        });
    }
